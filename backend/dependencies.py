...
class PredictionInput(BaseModel):
    ...
    # Additional required fields for ML pipeline
    yield_ta_per_ha: Optional[float] = 0.0
    area_thousand_ha: Optional[float] = 0.0
...
class PredictionOutput(BaseModel):
    ...
    # predicted_area is not predicted by the model, it's an input or derived
    # But we can return it for reference
    predicted_area: Optional[float] = None